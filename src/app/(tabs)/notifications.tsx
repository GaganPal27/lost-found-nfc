  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.headerSup}>ALERTS</Text>
        <Text style={styles.headerTitle}>Notifications</Text>
        <Text style={styles.headerSub}>What's happening with your posts</Text>
      </LinearGradient>

      {/* List */}
      <NotificationsList bottomPadding={tabBarClearance} />
    </View>
  );
}
